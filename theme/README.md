...
| `snippets/saibai-shell-css.liquid` | Shell consolidado (`core` + `cards` + legacy) |
| `snippets/saibai-pages-css.liquid` | Pages consolidado (PLP 1 · PDP 3 · cart/static…) |
| `snippets/saibai-conditional-assets.liquid` | Home: hero + `prod-home` + `home-sections` |
| `snippets/saibai-inst-css.liquid` | Inst: `core` + `pages` / blog / article · PLP: `inst-plp` |
| `assets/saibai-header-{base,mega,util}.css` | Header consolidado (3 masters) |
